defmodule TodoNotes.Accounts do
  @moduledoc """
  ...
  alias TodoNotes.Accounts.{User, UserToken, UserNotifier}
  ...
  See `TodoNotes.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `TodoNotes.Accounts.User.password_changeset/3` for a list of supported options.
