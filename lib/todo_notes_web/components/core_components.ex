defmodule TodoNotesWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TodoNotesWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TodoNotesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TodoNotesWeb.Gettext, "errors", msg, opts)
    end
  end
